...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="page-header">
		<hgroup>
			<?php the_title( '<h2 class="entry-title"><a href="' . get_permalink() .'" title="' . sprintf( esc_attr__( 'Permalink to %s', 'uc-customized' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark">', '</a></h2>' ); ?>
	...
	<div class="entry-content row">
		...
		<div class="span3">
			...
			<p class="gallery-meta">
				...
				<?php
				printf(
					_n( 'This gallery contains <strong>%1$s photo</strong>.', 'This gallery contains <strong>%1$s photos</strong>.', $the_bootstrap_total_images, 'uc-customized' ),
		...
		<div id="gallery-slider" class="carousel slide span5">
			...
			<!-- Carousel nav -->
			<a class="carousel-control left" href="#gallery-slider" data-slide="prev"><?php _ex( '&lsaquo;', 'carousel-control', 'uc-customized' ); ?></a>
			<a class="carousel-control right" href="#gallery-slider" data-slide="next"><?php _ex( '&rsaquo;', 'carousel-control', 'uc-customized' ); ?></a>
		</div><!-- #gallery-slider -->
...
/* Location: ./wp-content/themes/uc-customized/partials/content-gallery.php */